...
Model Goddard_Pierna_Front_Izq;
Model Goddard_Pierna_Front_Dere;
Model Goddard_Pierna_Trac_Izq;
Model Goddard_Pierna_Trac_Dere;
...
int main()
{
	...
	Goddard_Pierna_Front_Izq = Model();
	Goddard_Pierna_Front_Izq.LoadModel("Models/Pierna_Front_Izquierda.obj");

	Goddard_Pierna_Front_Dere = Model();
	Goddard_Pierna_Front_Dere.LoadModel("Models/Pierna_Front_Derecha.obj");

	Goddard_Pierna_Trac_Izq = Model();
	Goddard_Pierna_Trac_Izq.LoadModel("Models/Pierna_Trace_Izquierda.obj");

	Goddard_Pierna_Trac_Dere = Model();
	Goddard_Pierna_Trac_Dere.LoadModel("Models/Pierna_Trace_Derecha.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//Goddard_Mandibula.RenderModel();//modificar por el modelo sin las 4 patas y sin cola
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.0f, -2.0f, -0.4f));
		model = glm::rotate(model, glm::radians(mainWindow.getPiernaD1()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//Goddard_Pierna_Front_Izq.RenderModel();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getPiernaD2()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//Goddard_Pierna_Front_Dere.RenderModel();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getPiernaT1()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//Goddard_Pierna_Trac_Izq.RenderModel();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getPiernaT2()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//Goddard_Pierna_Trac_Dere.RenderModel();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		carro.RenderModel();
